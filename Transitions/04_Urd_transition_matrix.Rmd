---
title: "Markos et al Pseudotime and Transitions"
...
verbose_urd <- FALSE
RECALC_TM<-FALSE # If FALSE, only URD object is created, but no transition probabilities are computed for time saving purposes.
```


# Preprocess

Computing transition probabilities: `r RECALC_TM`
