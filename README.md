...
We provide a wrapper script file `Figure1_demo.sh` which executes annotation analysis for all timepoints and outputs pdf images comprising main Figure 1 into the Results directory. This directory also contains respective original images, allowing confirmation of successful execution. Use `sh ./Figure1_demo.sh` on linux-based OS (running time is around 6 minutes).
...
- **Individual_timepoints**
    ...
    - **Figure1_demo.sh**: Wrapper script for demonstrating functionality of the annotation workflow and authenticity of the data
- **Transitions**
...
- **Results**
    ...
    - **Fig1_*_original.pdf**: output of `Figure1_demo.sh`
- **Export**
