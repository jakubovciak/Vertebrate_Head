...
pl_n0_dot_gset<-DotPlot(
  AmphiN0stage,
  features = c("Ap2","Snail","Neurogenin","Tcf15","Axin","SoxB1c","Fgf8/17/18","Admp","Nodal","Shh","Six4/5","Chordin","Goosecoid","Dmbx","Six3/6","Six1/2","Fz5/8","Rspo2","Cerberus","Lhx2/9","FoxA1","Brachyury1","Mnx","Dkk1/2/4","Dkk3","Tbx15","Wnt8","Mrf1","Tbx2/3","Hex","Blimp","Prdm16","Nkx2-2","Nkx2-1","Gata4/5/6","Irxc","Wnt1","Wnt4","Wnt5"),
  cols = c('snow2', 'red1'),
  col.min = -2,
  col.max = 10,
  dot.min = 0,
