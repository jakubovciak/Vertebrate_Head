...
pl_g4_dot_gset<-DotPlot(
  AmphiG4stage,
  features = c("Ap2","Neurogenin","Sox1/2/3","Axin","Fgf8/17/18","Sp5","Delta","Wnt1","Wnt11","Wnt8","Dkk1/2/4","Chordin","Admp","Notch","Bambi","Lefty","Tbx2/3","Lhx3","Blimp","Fz5/8","Tbx15","Hand","Lhx1/5","Sfrp2-like","Goosecoid","Vsx2","Six4/5","Otx","FoxA1","Brachyury1","Nodal","Hex","Pitx2","Six3/6","Mrf1","Prdm16","Shh","Vent1"),
  cols = c('snow2', 'red1'),
  col.min = -2,
  col.max = 40,
  dot.min = 0,
